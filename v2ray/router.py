...
def add_inbound():
    ...
    remarkid = request.form['remarkid']
    inbound = Inbound(port, listen, protocol, settings, stream_settings, sniffing, remark, remarkid)
...
def update_inbound(in_id):
    ...
    add_if_not_none(update, 'remarkid', request.form.get('remarkid'))
